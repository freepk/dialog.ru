...
{tpl}
	{blk id="content.customer.form"}
		...
		<form action="/?action=register" method="post" style="margin: 5px 0 0 0;">
		<input type="hidden" name="event" value="finish" />
		<table summary="" cellpadding="0" cellspacing="1" style="width: 520px; margin: 5px 0 0 0;">
			<tbody>
				<tr>
					<td style="width: 250px; background-color: rgb(236,250,209); vertical-align: top;">E-Mail&nbsp;<span style="color: red;">*</span>&nbsp;:</td>
					<td style="width: 270px;"><input maxlength="50" style="width: 265px;" type="text" name="login" value="{/txt}{var id="params.login" /}{txt}" /></td>
				</tr>
				<tr>
					<td style="width: 250px; background-color: rgb(236,250,209); vertical-align: top;">Пароль&nbsp;<span style="color: red;">*</span>&nbsp;:</td>
					<td style="width: 270px;"><input maxlength="50" style="width: 265px;" type="password" name="password" /></td>
				</tr>
				<tr>
					<td style="width: 250px; background-color: rgb(236,250,209); vertical-align: top;">Фамилия Имя Отчество&nbsp;<span style="color: red;">*</span>&nbsp;:</td>
				...
				<tr>
					<td colspan="2" align="right"><input style="width: 130px; margin: 5px 0 0 0;" type="submit" value="Регистрация" /></td>
				</tr
			</tbody>
		</table>
		</form>
